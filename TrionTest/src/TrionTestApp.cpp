...
#ifdef _DEBUG
#pragma comment(lib, "../../../Triton SDK/lib/vc14/x64/Triton-MTD.lib")
#else
#pragma comment(lib, "../../../Triton SDK/lib/vc14/x64/Triton-MT.lib")
#endif
...
struct TrionTestApp : public App
{
    void setup() override
    {
...
CINDER_APP( TrionTestApp, RendererGl, [](App::Settings* settings) {
    readConfig();
