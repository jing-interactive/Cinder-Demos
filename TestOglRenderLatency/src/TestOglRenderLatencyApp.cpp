...
struct TestOglRenderLatencyApp : public App
{
    void setup() override
    {
        ...
        getWindow()->getSignalDraw().connect([&] {
            gl::ScopedDebugGroup scpDraw(toString(getElapsedFrames()));
            gl::setMatrices( mCam );
            gl::clear();
...
CINDER_APP( TestOglRenderLatencyApp, RendererGl, [](App::Settings* settings) {
    readConfig();
